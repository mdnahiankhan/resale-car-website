...
const router = createBrowserRouter([
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://resale-website-server-ten.vercel.app/options/${params.id}`)
            }
        ]
    },
    {
        ...
        children: [
            ...
            },
            {
                ...
                loader: ({ params }) => fetch(`https://resale-website-server-ten.vercel.app/bookings/${params.id}`)
            }
        ]
    }
])
